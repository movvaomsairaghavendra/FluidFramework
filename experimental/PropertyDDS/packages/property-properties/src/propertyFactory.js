...
class PropertyFactory {
    ...
    * */
    ...
    getTemplate(in_typeid) {
        return this._localPrimitivePropertiesAndTemplates.has(in_typeid) && !TypeIdHelper.isPrimitiveType(in_typeid) ? this._localPrimitivePropertiesAndTemplates.item(in_typeid).getPropertyTemplate() : undefined;
    }
        ...
        while (creationStack.length > 0) {
            ...
            if (currentEntry.def.constant) {
                ...
                if (currentEntry.parentVarName !== undefined) {
                    creationFunctionSource += currentEntry.def.optional ? `${currentEntry.parentVarName}._insert(
                ...
                // to signal that all child properties have been added
                    ...
                    if (initialValue !== undefined) {
                        creationFunctionSource += !_.isObject(initialValue.value) ? `${currentPropertyVarName}.setValue(${JSON.stringify(initialValue.value)});\n` : `this._setInitialValue(${currentPropertyVarName},
