...
export async function createContainer(params: IGetContainerParams): Promise<IContainer> {
...
export async function getContainer(params: IGetContainerParams): Promise<IContainer> {
	const load = async (): Promise<IFluidModuleWithDetails> => {
		return {
			module: { fluidExport: params.containerRuntimeFactory },
			details: { package: "no-dynamic-package", config: {} },
