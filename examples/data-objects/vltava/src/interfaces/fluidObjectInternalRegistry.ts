...
export const IFluidObjectInternalRegistry: keyof IProvideFluidObjectInternalRegistry =
 ...
 */
export interface IFluidObjectInternalRegistry<T = DefaultRegistryTypes>
	extends IProvideFluidObjectInternalRegistry<T> {
