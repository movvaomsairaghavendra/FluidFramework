...
export class TabsFluidObject extends DataObject implements IFluidHTMLView {
	...
	protected async hasInitialized() {
		...
		const registryDetails = (registry as IProvideFluidObjectInternalRegistry)
			.IFluidObjectInternalRegistry;
		this.dataModelInternal = new TabsDataModel(
			this.root,
			registryDetails,
	...
	public render(div: HTMLElement) {
		ReactDOM.render(<TabsView dataModel={this.dataModel} />, div);
	}
}
