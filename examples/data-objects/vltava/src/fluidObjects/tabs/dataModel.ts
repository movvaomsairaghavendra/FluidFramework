...
import { ISharedDirectory, IDirectory, IValueChanged } from "@fluidframework/map";
...
export class TabsDataModel extends EventEmitter implements ITabsDataModel {
	...
	constructor(
		...
		private readonly createSubObject: (
			factory: IFluidDataStoreFactory,
		) => Promise<IFluidLoadable>,
		...
		this.tabs.on("containedValueChanged", (changed: IValueChanged, local: boolean) => {
