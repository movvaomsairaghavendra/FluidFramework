...
export const LastEditedDisplay = (props: ILastEditedDisplayProps) => {
	...
	const nameParts = personaName.split(" ").reduce((acc: string[], val) => {
		acc.push(...val.split("_"));
		return acc;
	}, []);
	...
	const initialsColor =
		PersonaInitialsColor[
			PersonaInitialsColor[
				props.lastEditedState.user.colorCode % Object.keys(PersonaInitialsColor).length
			]
		];
	...
	return (
		<div style={lastEditedBoxStyle}>
			<div style={lastEditByStyle}>Last Edit By</div>
