...
import { InventoryListContainerRuntimeFactory as InventoryListContainerRuntimeFactory2 } from "./version2";
...
async function getContainerKillBitFromContainer(
	container: IContainer,
): Promise<IContainerKillBit> {
