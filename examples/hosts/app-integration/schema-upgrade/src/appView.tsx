...
export const AppView: React.FC<IAppViewProps> = (props: IAppViewProps) => {
	...
	const [sessionEnding, setSessionEnding] = useState<boolean>(
		containerKillBit.markedForDestruction,
	);
	...
	return (
		<div>
			...
			<button onClick={async () => saveAndEndSession().catch(console.error)}>
				Save and End Session
			</button>
			<br />
			<button onClick={async () => migrateContainer().catch(console.error)}>
