...
const collectionRequestHandler = async (
...
class ContactCollectionContainerRuntimeFactoryType extends BaseContainerRuntimeFactory {
	constructor() {
		super(new Map([ContactCollectionInstantiationFactory.registryEntry]), undefined, [
 ...
 */
export const ContactCollectionContainerRuntimeFactory =
	new ContactCollectionContainerRuntimeFactoryType();
