...
export namespace Original {
	...
	export type ModsMark = SetValue | Modify;
	export type AttachMark = Insert | MoveIn;
	export type DetachMark = MoveOut | Delete;
	export type SegmentMark = AttachMark | DetachMark;
	export type ObjMark = ModsMark | SegmentMark | SliceBound;

	export type Mark = ObjMark;
...
export namespace Rebased {
	...
	export interface Modify<TInner = Mark, AllowSetValue extends boolean = true>
		extends Original.Modify<TInner, AllowSetValue> {}
	...
	export type ModsMark = RevertValue | SetValue | Modify;
	export type AttachMark = Insert | MoveIn;
	export type DetachMark = MoveOut | Delete;
	export type SegmentMark = AttachMark | DetachMark;
	export type SliceBound = MoveOutStart | DeleteStart | SliceEnd;
	export type PriorSliceBound = PriorDeleteStart | PriorMoveOutStart | PriorSliceEnd;
	export type ObjMark =
		| ModsMark
		| SegmentMark
		| SliceBound
	...
	export type SliceStart = MoveOutStart | DeleteStart | PriorDeleteStart | PriorMoveOutStart;
