...
function makeOpsMap<T extends ISerializableInterval>(): Map<
	string,
...
export interface IIntervalCollectionEvent<TInterval extends ISerializableInterval>
	...
	(
		...
		listener: (interval: TInterval, propertyArgs: PropertySet) => void,
	);
}
...
> extends TypedEventEmitter<IIntervalCollectionEvent<TInterval>> {
	 ...
	 */
	public add(start: number, end: number, intervalType: IntervalType, props?: PropertySet) {
		if (!this.attached) {
