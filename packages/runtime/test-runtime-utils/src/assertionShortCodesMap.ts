...
export const shortCodeMap = {
	...
	"0x34a": "An edit is already open.",
	"0x34b": "An edit is not open.",
	"0x34c": "Locally constructed edits must be well-formed and valid",
	"0x34d": "Changes must be applied as part of an ongoing edit.",
	"0x34e": "Locally constructed edits must be well-formed and valid.",
	"0x34f": "Changes must be applied as part of an ongoing edit.",
	"0x350": "Changes must be applied as part of an ongoing edit.",
	"0x351": "An edit is not open.",
	"0x352": "Local edits should always be valid.",
	"0x353": "Malformed changes should have been caught on original application.",
	"0x354": "An edit is not open.",
	"0x355": "An edit is not open.",
	"0x356": "Duplicate acked edit.",
	"0x357": "An edit chunk should include at least a handle or edits.",
	...
	"0x35c": "Duplicate acked edit.",
	"0x35d": "Causal ordering should be upheld",
	"0x35e": "An edit chunk must have either a handle or a list of edits.",
	"0x35f": "node must have either both parent and traitParent set or neither",
	"0x360": "any trait arrays present in a node must be non-empty",
	"0x361": "can not give a child multiple parents",
	"0x362": "can not add node with already existing id",
	"0x363": "invalid attach index",
	"0x364": "can not insert children under node that does not exist",
	"0x365": "invalid attach index",
	"0x366": "can not attach node that already has a parent",
	"0x367": "invalid detach index range",
	"0x368": "can not detach children under node that does not exist",
	"0x369": "invalid detach index range",
	"0x36a": "can not replace payload for node that does not exist",
	"0x36b": "deleted nodes must be unparented",
	"0x36c": "node is parented incorrectly",
	"0x36d": "trait is present but empty",
	"0x36e": "child in trait is not in forest",
	"0x36f": "child is not parented",
	"0x370": "child parent pointer is incorrect",
	"0x371": "the item tree tree must not contain cycles or multi-parented nodes",
	"0x372": "cached parent is incorrect",
	"0x373": "Node is not parented",
	...
	"0x376": "revision must be an integer",
	"0x377": "revision must correspond to the result of a SequencedEdit",
	"0x378": "Local revision view cached out of order.",
	"0x379": "retentionWindowStart must be initialized >= 0",
	"0x37a": "Client id should be set if connected.",
	"0x37b": "Edit chunking is not supported in v0_0_2",
	"0x37c": "Summarizing should not occur with local edits except on first attach.",
	"0x37d": "generateSummary must not be called with local edits",
	...
	"0x381": "0.1.1 summary encountered with non-object edit history.",
	"0x382": "Missing editChunks on 0.1.1 summary.",
	"0x383": "Missing editIds on 0.1.1 summary.",
	"0x384": "root definition and identifier should be immutable.",
	"0x385": "0.0.2 summary encountered with missing sequencedEdits field.",
	"0x386": "root definition and identifier should be immutable.",
	"0x387": "transaction has already been closed",
	"0x388": "Editor must be open to apply changes.",
	"0x389": "identityHash constraint is not implemented",
	"0x38a": "contentHash constraint is not implemented",
	"0x38b": "Root node was compressed with no ID",
	"0x38c": "Delta can only be calculated between views that share a root",
	"0x38d": "Keys in map must be sorted.",
	"0x38e": "Values in map must be sorted.",
	"0x38f": "Clusters must have a positive capacity",
	"0x390": "Clusters must not exceed max cluster size",
	"0x391": "reservedIdCount must be non-negative",
	"0x392": "Non-empty range must properly consume local IDs",
	"0x393": "A session's attribution ID may never be modified.",
	"0x394": "Ranges finalized out of order.",
	"0x395": "Cannot finalize an empty range.",
	...
	"0x39a": "Ranges finalized out of order.",
	...
	"0x39f": "Cannot add a second override for final id",
	"0x3a0": "Session ID Normalizer produced unexpected local ID",
	"0x3a1": "Session ID Normalizer produced unexpected local ID",
	"0x3a2": "session not serialized",
	"0x3a3": "Cannot resume existing session.",
	"0x3a4": "AttributionId index out of bounds",
	"0x3a5": "malformed IdCreationRange",
	"0x3a6": "Local ID space must start at -1.",
	"0x3a7": "Local ID space must be contiguous.",
	"0x3a8": "Malformed normalization range.",
	"0x3a9": "Gaps in final space must align to a local.",
	"0x3aa": "Malformed normalization block.",
	"0x3ab": "Final ID block should not be registered without an existing local range.",
	"0x3ac": "Empty range should not be reified.",
	...
	"0x3af": "",
	"0x3b0": "unexpected detached ID",
	"0x3b1": "unexpected detached ID",
	"0x3b2": "Test error.",
	"0x3b3": "Test error.",
	"0x3b4": "Test error.",
	"0x3b5": "Must allocate a non-zero number of IDs",
	...
	"0x3bb": "reentrancy?",
	"0x3bc": "reentrancy?",
	"0x3bd": "processDeltas() should run async",
