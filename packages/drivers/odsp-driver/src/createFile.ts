...
export async function createNewEmptyFluidFile(
	...
	const initialUrl = `${getApiRoot(getOrigin(newFileInfo.siteUrl))}/drives/${newFileInfo.driveId}/items/root:/${
		filePath
...
export async function createNewFluidFileFromSummary(
	...
	const initialUrl = `${baseUrl}:/opStream/snapshots/snapshot${
		newFileInfo.createLinkType ? `?createLinkType=${newFileInfo.createLinkType}` : ""
	}`;
 ...
 */
export function convertSummaryToSnapshotTreeForCreateNew(
