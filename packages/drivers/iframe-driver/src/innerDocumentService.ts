...
export class InnerDocumentService implements IDocumentService {
	...
	public static async create(
		...
		return new InnerDocumentService(proxyObject, resolvedUrl, proxyObject.clientId, logger);
	}
	...
	public async connectToStorage(): Promise<IDocumentStorageService> {
		return new DocumentStorageServiceProxy(
			this.outerProxy.storage as unknown as IDocumentStorageService,
		);
	}
